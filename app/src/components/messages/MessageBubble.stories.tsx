...
/** User's message (right-aligned, primary color) */
...
/** Other person's message (left-aligned, with avatar) */
...
/** Other person's message without avatar (for grouped messages) */
...
/** Conversation preview showing multiple messages */
