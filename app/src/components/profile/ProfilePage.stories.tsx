  ...
  render: () => (
    <div class="min-h-screen bg-background p-8">
      <div class="max-w-md mx-auto">
        ...
        {/* 2-col grid, no separators */}
        <div class="grid grid-cols-2 gap-x-8 gap-y-3 mt-6">
          <ProfileBadge category="Age" value="25-29" attested />
          <ProfileBadge category="Sex" value="Female" attested />
          <ProfileBadge category="Nationality" value="Japan" attested />
          <ProfileBadge category="Gender" value="Woman" />
          <ProfileBadge category="Looking for" value="Relationship" />
          <ProfileBadge category="Body" value="Athletic" />
          <ProfileBadge category="Fitness" value="Very active" />
          <ProfileBadge category="Smoking" value="Never" />
          <ProfileBadge category="Drinking" value="Socially" />
          <ProfileBadge category="Kids" value="Don't have, open to it" />
          <ProfileBadge category="Kids timeline" value="In 2-5 years" />
          <ProfileBadge category="Relationship" value="Monogamish" />
          <ProfileBadge category="Religion" value="Spiritual" />
          <ProfileBadge category="Kink" value="Open-minded" />
          <ProfileBadge category="Income" value="$75-100K" />
        </div>
      </div>
    </div>
  ),
