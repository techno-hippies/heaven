...
import { Eye, Users, Lock, ArrowRight, ShieldCheck } from 'phosphor-solid'
...
interface BiologicalSexPageProps {
  step?: number
  totalSteps?: number
  /** Verified biological sex from self.xyz passport (0=M, 1=F) */
  verifiedSex: number
  onContinue?: (visibility: Visibility) => void
}

export const BiologicalSexPage: Component<BiologicalSexPageProps> = (props) => {
  // Default to Secret for maximum privacy
  ...
  const sexLabel = () => SEX_LABELS[props.verifiedSex] ?? 'Unknown'
        ...
        <div class="w-full max-w-lg mx-auto px-6 py-8">
          ...
          <div class="mb-8">
            ...
            <p class="text-lg" style={{ color: colors.textSecondary }}>
              From your passport. You control who sees this.
            </p>
          </div>

          {/* Verified Sex Display */}
          <div class="mb-10">
            <div
            ...
            >
              <p class="text-base" style={{ color: colors.textSecondary }}>
                This is separate from your gender identity. Many people keep this
                private while sharing their gender publicly.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="mt-6">
              <Show when={visibility() === 'public'}>
                <p class="text-base" style={{ color: colors.textSecondary }}>
                  Your biological sex will appear on your profile for everyone to see.
                </p>
              </Show>
              <Show when={visibility() === 'shared'}>
                <p class="text-base" style={{ color: colors.textSecondary }}>
                  Hidden while browsing. When you match, this is revealed to each other.
                </p>
              </Show>
              <Show when={visibility() === 'secret'}>
                <p class="text-base" style={{ color: colors.textSecondary }}>
                  Encrypted and never shown to anyone. Only used to ensure you appear
                  to people whose preferences include you.
                </p>
              </Show>
            </div>
          </div>
...
export default BiologicalSexPage
