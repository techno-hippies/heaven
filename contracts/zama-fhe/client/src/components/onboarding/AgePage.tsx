...
interface AgePageProps {
  step?: number
  totalSteps?: number
  /** Verified age from self.xyz passport */
  verifiedAge: number
  onContinue?: (visibility: Visibility) => void
}

export const AgePage: Component<AgePageProps> = (props) => {
        ...
        <div class="w-full max-w-lg mx-auto px-6 py-8">
          ...
          <div class="mb-8">
            ...
            <p class="text-lg" style={{ color: colors.textSecondary }}>
              Verified from your passport. Choose who can see it.
            </p>
          </div>

          {/* Verified Age Display */}
          <div class="mb-10">
            <div
            ...
            >
              <div class="text-center">
                ...
                <p class="text-lg mt-2" style={{ color: colors.textMuted }}>
                  years old
                </p>
              </div>
            ...
            <div class="mt-6">
              <Show when={visibility() === 'public'}>
                <p class="text-base" style={{ color: colors.textSecondary }}>
                  Your exact age will appear on your profile for everyone to see.
                </p>
              </Show>
              <Show when={visibility() === 'shared'}>
                <p class="text-base" style={{ color: colors.textSecondary }}>
                  Your age stays hidden while browsing. When you match, your age bracket
                  (5-year range) is revealed to each other.
                </p>
              </Show>
              <Show when={visibility() === 'secret'}>
                <p class="text-base" style={{ color: colors.textSecondary }}>
                  Your age is encrypted and never shown. It's only used to ensure you appear
                  to people whose age preferences include you.
                </p>
              </Show>
            </div>
          </div>
