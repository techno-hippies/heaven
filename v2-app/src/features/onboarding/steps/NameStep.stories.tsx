...
const meta = {
  title: 'Features/Onboarding/Steps/NameStep',
  component: NameStep,
  parameters: {
    layout: 'padded',
  },
...
export const Default: Story = {
  render: () => {
    const [data, setData] = createSignal<NameStepData>({})
    return (
...
export const WithExistingName: Story = {
  render: () => {
    const [data, setData] = createSignal<NameStepData>({ name: 'sakura', tld: 'heaven' })
    return (
      <div class="w-full px-6 py-6">
        <div class="max-w-2xl mx-auto space-y-6">
          <StepHeader title={nameStepMeta.title} subtitle={nameStepMeta.subtitle} />
...
export const StarTLD: Story = {
  render: () => {
    const [data, setData] = createSignal<NameStepData>({ name: 'alice', tld: 'star' })
    return (
      <div class="w-full px-6 py-6">
        <div class="max-w-2xl mx-auto space-y-6">
          <StepHeader title={nameStepMeta.title} subtitle={nameStepMeta.subtitle} />
