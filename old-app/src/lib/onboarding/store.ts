...
export interface OnboardingData {
  ...
  // Step 7: Relationship Structure (About me)
  relationshipStructure?: string
  relationshipStructureVisibility: Visibility

  // Step 7b: Relationship Structure Preferences (What I want)
  wantRelationshipStructure?: string
  wantRelationshipStructureStrict: boolean

  // Step 8: Kids (About me)
  kids?: string
  kidsVisibility: Visibility

  // Step 8b: Kids Preferences (What I want)
  wantKids?: string
  wantKidsStrict: boolean
...
export const defaultOnboardingData: OnboardingData = {
  ...
  wantRelationshipStructureStrict: false,
  kidsVisibility: 'match',
  wantKidsStrict: false,
