...
const faqCategories: FAQCategory[] = [
  ...
  {
    title: 'Tradeoffs & Balance',
    items: [
      {
        question: 'How do gender preferences work here?',
        answer: 'You choose your gender identity (Man, Woman, Trans man, Trans woman, Non-binary) and separately choose who you want to see. Preferences can be precise (e.g., Women only, Women + Trans women, Everyone). Matching is enforced only when there is a mutual like, so you do not end up in a match that violates either person\'s settings.',
      },
      {
        question: 'Do I have to disclose my gender identity publicly?',
        answer: 'No. Gender is stored encrypted and is not posted publicly on-chain. You can choose whether to share your gender identity with a match, or keep it private even after matching.',
      },
      {
        question: 'Why not just group everyone as "men/women/non-binary"?',
        answer: 'Some people want broader matching; others want more specific preferences. We support both without forcing anyone into separate discovery pools or requiring public labels. The goal is to respect individual preferences while minimizing exposure of sensitive information.',
      },
      {
        question: 'What does Self.xyz verify, and what do you intentionally not collect?',
        answer: 'We use Self.xyz only to verify what we need (for example, age). We intentionally do not request "sex" from passport/ID documents, even if it could be encrypted, because collecting less sensitive data is a stronger privacy posture.',
      },
    ],
  },
  {
